            ...
            {contactMethods.map((method, index) => (
              <div key={index} className="text-center p-6 home-card">
                ...
                {method.link ? (
                  <a
                    href={method.link}
                    className="font-medium block mb-2" style={{color:'var(--color-crimson-red)'}}
                  >
                    {method.value}
                  </a>
                ) : (
                  <p className="home-title-dark font-medium mb-2">
                    {method.value}
                  </p>
                )}
                <p className="text-sm home-text-dark">
                  {method.description}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 home-section-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl home-text-dark">
          ...
          <div className="home-card">
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium home-title-dark mb-2">
                    First Name *
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="home-btn-primary text-lg px-8 py-3 flex items-center home-accent-border"
                >
